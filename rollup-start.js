...
const OLSKAppToolbar = new RollupStart({
	...
	props: Object.assign({
		...
		OLSKAppToolbarDispatchClub: (function  () {
			window.TestOLSKAppToolbarDispatchClub.innerHTML = parseInt(window.TestOLSKAppToolbarDispatchClub.innerHTML) + 1;
		}),
		...
		if (['OLSKAppToolbarDispatchApropos', 'OLSKAppToolbarDispatchTongue', 'OLSKAppToolbarDispatchFund', 'OLSKAppToolbarDispatchClub', 'OLSKAppToolbarFundShowProgress', 'OLSKAppToolbarDispatchLauncher', 'OLSKAppToolbarFundLimitText'].includes(e[0]) && e[1].trim()) {
			e[1] = JSON.parse(e[1]);
		}
