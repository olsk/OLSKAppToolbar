...
const OLSKAppToolbar = new RollupStart({
	...
	props: Object.assign({
		...
		OLSKAppToolbarDispatchMembership: (function  () {
			window.TestOLSKAppToolbarDispatchMembership.innerHTML = parseInt(window.TestOLSKAppToolbarDispatchMembership.innerHTML) + 1;
		}),
		...
		if (['OLSKAppToolbarDispatchApropos', 'OLSKAppToolbarDispatchTongue', 'OLSKAppToolbarDispatchFund', 'OLSKAppToolbarDispatchMembership', 'OLSKAppToolbarFundShowProgress', 'OLSKAppToolbarDispatchLauncher', 'OLSKAppToolbarFundLimitText'].includes(e[0]) && e[1].trim()) {
			e[1] = JSON.parse(e[1]);
		}
